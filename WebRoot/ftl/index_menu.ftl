...
<section id="secondary_bar">
		<div class="user">
			<#if Session.sysUserSessionInfo?exists!>
				<p>${Session.sysUserSessionInfo.userRealName!}</p>
			<#else>
				<p>尚未登录</p>
			</#if>
		</div>
	...
	<aside id="sidebar" class="column" style="min-height:600px;">
		<hr/>
			...
			<h3 id="topmenuid5" data-url="/sso/user/index.do?url=user/list">用户管理</h3>
			<h3 id="topmenuid6" data-url="/sso/sysConfig/index.do?url=sysconfig/sysConfig">系统配置</h3>
			<h3 id="topmenuid7" data-url="/sso/log/index.do?url=log/list">日志查看</h3>
